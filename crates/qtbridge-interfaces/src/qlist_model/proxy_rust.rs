...
impl<T: QListModelAdapter + 'static> qtbridge_runtime::qproxies::AdapterUpcast<T> for QListModelProxyRust {
    fn upcast(rc: std::rc::Rc<std::cell::RefCell<T>>) -> std::rc::Rc<std::cell::RefCell<dyn QListModelAdapter>> {
        rc
    }
}
